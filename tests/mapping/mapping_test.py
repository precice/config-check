...
from preciceconfigcheck.rules.coupling_scheme_mapping import (
    CouplingSchemeMappingRule as csm,
)
...
def test_mapping():
    ...
    violations_expected = [
        ...
        csm.MissingMappingCouplingSchemeViolation(
            p_propagator, p_generator, m_propagator, d_color
        ),
        csm.MissingMappingCouplingSchemeViolation(
            p_incinerator, p_propagator, m_incinerator, d_color
        ),
        csm.MissingMappingCouplingSchemeViolation(
