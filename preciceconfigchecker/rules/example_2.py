...
class Rule_2(Rule):
    class MyViolation(Violation):
        def __init__(self, node_a:str, node_b:str, node_c:str, line:int) -> None:
            self.node_a = node_a
            self.node_b = node_b
            self.node_c = node_c
            super().__init__(line)
    ...
    def check(self) -> None:
        ...
        self.violations.append(self.MyViolation("Node-G", "Node-H", "Node-I", 4))
        self.violations.append(self.MyViolation("Node-J", "Node-K", "Node-L", 5))
